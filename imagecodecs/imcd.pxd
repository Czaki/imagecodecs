...
cdef extern from 'imcd.h':
    ...
    imcd_lzw_handle_t* imcd_lzw_new(ssize_t buffersize) nogil

    void imcd_lzw_del(imcd_lzw_handle_t* handle) nogil
    ...
    bint imcd_lzw_check(const uint8_t* src, const ssize_t size) nogil
