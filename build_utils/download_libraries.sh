...
git clone --depth 1 --branch v1.17.1 https://github.com/Blosc/c-blosc "${download_dir}/c-blosc"
...
git clone --depth 1 --branch 1.1.7 https://github.com/google/snappy "${download_dir}/snappy"
...
rm jxrlib_1.1.orig.tar.gz liblzf-3.6.tar.gz
